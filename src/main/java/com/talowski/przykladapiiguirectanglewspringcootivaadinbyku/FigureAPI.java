...
public class FigureAPI {
    ...
    public static int calculateCircumference(@RequestParam String figure, @RequestParam int siteA, @RequestParam int siteB, @RequestParam(required = false) Integer siteC) {
